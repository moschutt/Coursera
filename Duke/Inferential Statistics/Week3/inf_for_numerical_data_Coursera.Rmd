...
inference(y = weeks, data = nc, conf_level=0.99, 
          statistic = "mean", type = "ci", null = 0, 
          alternative = "twosided", method = "theoretical")
```
...
inference(y = weeks, data = nc, conf_level=0.90, 
          statistic = "mean", type = "ci", null = 0, 
          alternative = "twosided", method = "theoretical")
```
